...
Sensor circuit and power supply board have been both fixed on an aluminum support covered by black duct tape~\ref{fig:mppc2}.
\begin{figure}[!h]
\begin{center}
...
The SiPM signal was read and processed by electronic chain whose diagram is reported in Fig. 

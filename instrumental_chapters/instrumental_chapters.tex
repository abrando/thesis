...
\begin{figure}[!h]
\begin{center}
\includegraphics[scale=0.34]{imm/gagg1.jpg}
\end{center}
...
\end{figure}
\newpage
Sources of $^{241}Am$, $^{109}Cd$, $^{133}Ba$, $^{55}Fe$, $^{137}Cs$ have been used to illuminate the rod, placed at a distance of about $5mm$ from the rod top, put on a circular aluminum support designed for the used radioactive sources (Fig.~\ref{fig:support1}). The source has a diameter of $3mm$. It's flux has not been collimated.\\
...
\begin{figure}[!h]
\begin{center}
\includegraphics[scale=0.5]{imm/chain.png}
\end{center}

...
\subsection{Set-up parameters}
Eljen plastic scintillators have a light yield $\sim 3$-times lower than than GAGG, as discussed at the beginning of chapter. Therefore I needed to use a circuit board with increased nominal gain to 100. Used power supply circuit board was C12332 produced by Hamamatsu: the same tested for GAGG rod, but with an increased gain in preamplifier. \\

...
Used SiPMs have been studied by Bonanno et al.~\cite{sipm:1} that measured their photon detection efficiency (PDE) (Fig~\ref{fig:sipm}).

\begin{figure}[!h]
\begin{center}
\includegraphics[scale=0.5]{imm/lct_+3_pde_conf.png}
\end{center}
\caption{PDE}. 
\label{fig:sipm}
\end{figure}
